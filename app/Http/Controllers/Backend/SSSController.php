...
class SSSController extends Controller
{
    ...
    { $blogs=SSS::all()->sortBy('blog_sort');
    ...
    public function show(SSS $blogs)
    {
        //
    }
    ...
    {
        $blogsEdit=SSS::where('id',$id)->first();
    ...
    {     if($request->blog_slug>3){
        ...
        if($request->hasFile('blog_imagepath')){
            ...
            $blogsUpdate=SSS::where('id',$id)->update([
    ...
    public function switch(Request $request, $id){
        $switchStatus = SSS::where('id', intval($id))->update([
