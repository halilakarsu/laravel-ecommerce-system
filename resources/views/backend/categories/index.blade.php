                    ...
                    <div class="col-lg-8 p-r-0 title-margin-right">
                        <div class="page-header">
                            <div class="page-title">
                                <h1>Kategori Sayfası <br><span>Siteye ait kategori detayları bu sayfada düzenlenmektedir.</span>
                                </h1>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="page-header">
                            <div class="page-title">
                                <ol class="breadcrumb">
                                    ...
                                    <a href="{{route('categories.create')}}" class="btn btn-success mini mt-5"><i class="fa fa fa-plus-circle"></i><small> Ekle</small></a>
                                </ol>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="table-responsive">
                                        <table id="example" class="display" style="width:100%">
                                            ...
                                            @foreach($categories as $key)
                                                <tr id="item-{{$key->id}}">
                                                    <td class="sortable" ><img width="70px" src="/backend/images/categories/{{$key->categori_imagepath}}" alt="{{$key->categori_slug}}"></td>
                                                    ...
                                                    <td>
                                                        <a title="Düzenle" class="button btn-success btn mini" href="{{route('categories.edit',$key->id)}}">  <i class="fa fa-edit"></i></a>
                        ...
                        <script>
                            ...
                            $(document).ready(function() {
                                ...
                                $(document).on('click', '.btn-danger', function() {
                                    var kategoriId = $(this).data('id'); // Tıklanan butondan kategori ID'yi al
                                    var $row = $(this).closest('tr'); // Silinen kategoriun satırını seç
                                    alertify.confirm('Lütfen Silme İşlemini Onaylayın','Bu işlem bir daha geri alınmayacaktır',
                                        function () {
                                            $.ajax({
                                                type:"DELETE",
                                                url: '/categories/' + kategoriId,  // DELETE isteği için URL
