                    ...
                    <div class="col-lg-8 p-r-0 title-margin-right">
                        <div class="page-header">
                            <div class="page-title">
                                <h1>Alt Kategori Sayfası <br><span>Siteye ait alt kategori detayları bu sayfada düzenlenmektedir.</span>
                                </h1>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="page-header">
                            <div class="page-title">
                                <ol class="breadcrumb">
                                    ...
                                    <a href="{{route('types.create')}}" class="btn btn-success mini mt-5"><i class="fa fa fa-plus-circle"></i><small> Ekle</small></a>
                                </ol>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <table id="example" class="display" style="width:100%">
                                            ...
                                            @foreach($types as $key)
                                                <tr id="item-{{$key->id}}">
                                                    ...
                                                    <td>
                                                        <a title="Düzenle" class="button btn-success btn mini" href="{{route('types.edit',$key->id)}}">  <i class="fa fa-edit"></i></a>
                                ...
                                $(document).on('click', '.btn-danger', function() {
                                    ...
                                    alertify.confirm('Lütfen Silme İşlemini Onaylayın','Bu işlem bir daha geri alınmayacaktır',
                                        function () {
                                            $.ajax({
                                                type:"DELETE",
                                                url: '/types/' + kategoriId,  // DELETE isteği için URL
