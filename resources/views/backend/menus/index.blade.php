                    ...
                    <div class="col-lg-8 p-r-0 title-margin-right">
                        <div class="page-header">
                            <div class="page-title">
                                <h1>Menü Sayfası <br><span>Siteye ait menu detayları bu sayfada düzenlenmektedir.</span>
                                </h1>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="page-header">
                            <div class="page-title">
                                <ol class="breadcrumb">
                                    ...
                                    <a href="{{route('menus.create')}}" class="btn btn-success mini mt-5"><i class="fa fa fa-plus-circle"></i><small> Ekle</small></a>
                                </ol>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="table-responsive">
                                        <table id="example" class="display" style="width:100%">
                                            ...
                                            <tr id="item-{{$key->id}}">
                                                ...
                                                <td>
                                                    <a title="Düzenle" class="button btn-success btn mini" href="{{route('menus.edit',$key->id)}}">  <i class="fa fa-edit"></i></a>
...
<script>
 ...
 $(document).on('click', '.btn-danger', function() {
     var menuId = $(this).data('id'); // Tıklanan butondan menu ID'yi al
     var $row = $(this).closest('tr'); // Silinen menuun satırını seç
