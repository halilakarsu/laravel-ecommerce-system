                    ...
                    <div class="col-lg-8 p-r-0 title-margin-right">
                        <div class="page-header">
                            <div class="page-title">
                                <h1>Slider Sayfası <br><span>Siteye ait slider detayları bu sayfada düzenlenmektedir.</span>
                                </h1>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="page-header">
                            <div class="page-title">
                                <ol class="breadcrumb">
                                    ...
                                    <a href="{{route('sliders.create')}}" class="btn btn-success mini mt-5"><i class="fa fa fa-plus-circle"></i><small> Ekle</small></a>
                                </ol>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <table id="example" class="display" style="width:100%">
                                            ...
                                            @foreach($sliders as $key)
                                                ...
                                                <tr id="item-{{$key->id}}">
                                                    ...
                                                    <td>{{$key->slider_small_title}}</td>
                                                    <td>  <div style="margin-left:-40px;margin-top:10px" class="form-check form-switch text-lg-left ">
                                                            <label class="custom-switch">
                                                                <input data-id="{{$key->id}}" type="checkbox" class="custom-switch-input" {{$key->slider_status==1 ? "checked": ""}}>
                                                                <span class="custom-switch-slider"></span>
                                                            </label>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <a title="Düzenle" class="button btn-success btn mini" href="{{route('sliders.edit',$key->id)}}">  <i class="fa fa-edit"></i></a>
                        ...
                        <script>
                            ...
                            $(document).ready(function() {
                                ...
                                $(document).on('click', '.btn-danger', function() {
                                    var sliderId = $(this).data('id'); // Tıklanan butondan slider ID'yi al
                                    var $row = $(this).closest('tr'); // Silinen sliderun satırını seç
                                    alertify.confirm('Lütfen Silme İşlemini Onaylayın','Bu işlem bir daha geri alınmayacaktır',
                                        function () {
                                            $.ajax({
                                                type:"DELETE",
                                                url: '/sliders/' + sliderId,  // DELETE isteği için URL
